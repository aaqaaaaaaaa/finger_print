...
class CustomAndroidAuthMessages {
  const CustomAndroidAuthMessages({
    this.biometricHint,
...
String get androidBiometricHint => Intl.message('Shaxsni tasdiqlang',
    desc:
...
String get androidCancelButton => Intl.message('Bekor qilish',
...
String get androidSignInTitle => Intl.message('Autentifikatsiya talab qilinadi',///
