...
import 'package:finger_print/page/lock/presentation/widgets/auth_string.dart';
import 'package:flutter/foundation.dart' show visibleForTesting;
import 'package:flutter/services.dart';
import 'package:platform/platform.dart';

import 'error_codes_custom.dart';
...
class LocalAuthentication {
  ...
  Future<bool> authenticateWithBiometrics({
    ...
    CustomAndroidAuthMessages androidAuthStrings = const CustomAndroidAuthMessages(),
  ...
  /// simulator.
  Future<bool> customAuthenticate({
    required String localizedReason,
    bool useErrorDialogs = true,
    bool stickyAuth = false,
    CustomAndroidAuthMessages androidAuthStrings = const CustomAndroidAuthMessages(),
